...
**Product:** DeepL Translate (CORE)
**Reference:** DoC-deepltranslate_core-6.1.0

## 1. Product identification

- **Product name:** DeepL Translate (CORE)
- **Type:** TYPO3 Extension
- **Extension key / package:** deepltranslate_core (web-vision/deepltranslate-core)
- **Version:** 6.1.0 (initial issuance of this declaration)
- **Valid for:** version 6.1.0 and subsequent releases, until superseded by a new declaration issued for a later substantial modification (Art. 3(30) CRA)
- **Distribution channels:** TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/deepltranslate_core; Packagist — https://packagist.org/packages/web-vision/deepltranslate-core
...
DeepL Translate (CORE), version 6.1.0, as distributed via the TYPO3
...
> type DeepL Translate (CORE) is in compliance with Regulation (EU) 2024/2847.
>
> The full text of the EU declaration of conformity is available at the
> following internet address:
> https://security.web-vision.de/conformity/web-vision/deepltranslate-core/6.1.0/en/
