...
**Reference:** DoC-deepltranslate_core-5.2.0

## 1. Product identification

- **Product name:** DeepL Translate
- **Type:** TYPO3 Extension
- **Extension key / package:** deepltranslate_core (web-vision/deepltranslate-core)
- **Version:** 5.2.0 (initial issuance of this declaration)
- **Valid for:** version 5.2.0 and subsequent releases, until superseded by a new declaration issued for a later substantial modification (Art. 3(30) CRA)
...
DeepL Translate, version 5.2.0, as distributed via the TYPO3 Extension
...
> type DeepL Translate is in compliance with Regulation (EU) 2024/2847.
>
> The full text of the EU declaration of conformity is available at the
> following internet address:
> https://security.web-vision.de/conformity/web-vision/deepltranslate-core/5.2.0/en/
