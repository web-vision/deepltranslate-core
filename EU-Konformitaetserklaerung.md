...
**Produkt:** DeepL Translate (CORE)
**Referenz:** DoC-deepltranslate_core-6.1.0

## 1. Produktidentifikation

- **Produktname:** DeepL Translate (CORE)
- **Typ:** TYPO3-Extension
- **Extension Key / Package:** deepltranslate_core (web-vision/deepltranslate-core)
- **Version:** 6.1.0 (Erstausstellung dieser Erklärung)
- **Gültig für:** Version 6.1.0 und nachfolgende Releases, bis eine neue Erklärung wegen einer späteren wesentlichen Änderung (Art. 3 Nr. 30 CRA) ausgestellt wird
- **Vertriebskanäle:** TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/deepltranslate_core; Packagist — https://packagist.org/packages/web-vision/deepltranslate-core
...
DeepL Translate (CORE), Version 6.1.0, vertrieben über das TYPO3
...
> Elementen des Typs DeepL Translate (CORE) der Verordnung (EU) 2024/2847 entspricht.
>
> Der vollständige Text der EU-Konformitätserklärung ist unter der
> folgenden Internetadresse verfügbar:
> https://security.web-vision.de/conformity/web-vision/deepltranslate-core/6.1.0/de/
