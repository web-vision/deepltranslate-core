...
final class DeeplService
{
    ...
    /**
     * The translator handles its input as HTML, so plain text is escaped to keep "<" and "&" literal.
     */
    ...
    /**
     * Rich text is returned as the HTML the translator serialized, which is the form the rich text editor
