...
class Localization {
  ...
  private async initialize(): Promise<void> {
    ...
    //------------------------------------------------------------------------------------------------------------------
    // deepltranslate custom icon markup
    //------------------------------------------------------------------------------------------------------------------
    // Note 'inline' is required to enforce inlining of the svg, otherwise the `currentColor` light/darkmode override
    // in the svg would not work as TYPO3 is loading custom svg as img tag and not as inline svg. (core-bug)
    //------------------------------------------------------------------------------------------------------------------
